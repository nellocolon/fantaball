# Regole della Rosa — Fantaball

**Versione 1.0 — minimale**
Da affiancare al *Regolamento Punteggi*. Filosofia: poche regole, tutto immediato, comprensibile in meno di un minuto.
...
I 4 slot restanti li distribuisci come vuoi: 3-4-3, 4-4-2, 3-5-2, 4-3-3, ecc. Sempre 1 solo portiere in campo.

---

## 3. Capitano

Scegli **1 capitano** e **1 vice capitano** tra gli 11 titolari.

- **Capitano**: i suoi punti valgono **×2**
- **Vice**: se il capitano non gioca (0 minuti), il vice prende **×1,5**

Il moltiplicatore non può farti perdere punti: se il totale del capitano è negativo, conta 0. (Dettagli nel Regolamento Punteggi.)

---

## 4. Auto-sostituzione

Se un tuo titolare **non gioca** (0 minuti in campo), entra automaticamente la prima riserva disponibile dello stesso reparto che ha giocato, rispettando lo schema minimo.

- L'ordine di subentro delle 4 riserve lo decidi tu prima della partita.
- Se non c'è una riserva valida per quel ruolo, lo slot vale 0 punti.
- L'auto-sostituzione è automatica e gratuita: non costa nulla, non è un transfer.

---

## 5. Transfer tra le fasi

La rosa si blocca all'inizio di ogni fase e si può modificare solo nelle **finestre** tra una fase e l'altra:
...
- Puoi sostituirlo spendendo un transfer, come per qualsiasi altro cambio.
- Quando lo sostituisci, **recuperi il 50% del prezzo** che avevi pagato per lui, da riusare sul sostituto.
...
La squadra "sexy" ti dà 4 campioni veri ma quasi zero margine per i rimpiazzi. La "bilanciata" rinuncia a una stella per tenere crediti da parte quando le nazionali iniziano a uscire. Il tutto-stelle resta un sogno: il budget non lo consente. Questa è la scelta strategica del gioco.
...
5. **Transfer** solo nelle finestre tra le fasi.
6. Giocatore eliminato → lo sostituisci con un transfer e **recuperi il 50%** del suo prezzo. Se i crediti non bastano, schieri in 10.
